...
const Footer = () => {
    return (
        <footer className="w-full py-6 mt-4 border-t border-gray-200 bg-footer-bg bg-opacity-30">
            <div className="container flex flex-col items-center px-5 mx-auto space-y-4 lg:space-y-0 lg:flex-row lg:justify-between">
                <div>
                    <p>
                       <strong>blogframeworks</strong> 2021 - Hecho con mucho amor 
                    </p>
                </div>
                <div>
